...
class TaxNLPProcessor:
    def __init__(self):
        """Initialize NLP components and download required resources"""
        try:
            ...
            self.intent_patterns = {
                'calculation': [
                    ...
                    'find tax', 'determine tax', 'tax amount'
                ],
                'tax_info': [
                    'what is tax', 'explain tax', 'tell me about tax',
                    'tax information', 'tax details', 'tax system'
                ],
                'deduction': [
                    'deduction', 'relief', 'reduce tax', 'tax relief',
                    'allowance', 'exemption', 'qualifying payment'
                ],
                'deadline': [
                    'when', 'deadline', 'due date', 'payment date',
                    'filing date', 'last date', 'schedule'
                ],
                'help': [
            ...
            self.conversation_patterns = {
                ...
                'affirmative': [
                    'yes', 'yeah', 'sure', 'okay', 'ok', 'correct', 'right'
                ],
                'negative': [
                    'no', 'nope', 'not', "don't", 'wrong', 'incorrect'
                ],
                'confusion': [
                    'what', 'how', 'why', 'when', 'where', 'confused',

# Generated by Django 4.2.20 on 2025-04-30 05:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_feedback', models.BooleanField(default=None, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('conversation_id', models.CharField(default='default', max_length=100)),
            ],
            options={
                'db_table': 'taxmate_chatbot_userquery',
                'indexes': [models.Index(fields=['user_feedback'], name='feedback_idx'), models.Index(fields=['conversation_id'], name='conv_id_idx')],
            },
        ),
        migrations.CreateModel(
            name='TaxRateByType',
